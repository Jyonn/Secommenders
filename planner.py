...
GROUPS = {
    ...
    'sid': {
        ...
        'sid_embedding_models': None,
        'sid_embedding_normalize': None,
        'sid_embedding_reduce_dims': None,
        'sid_embedding_weights': None,
    ...
    'hash': {
        ...
        'hash_embedding_models': None,
        'hash_embedding_normalize': None,
        'hash_embedding_reduce_dims': None,
        'hash_embedding_weights': None,
    ...
    'uid': {
        ...
        'cluster_window': 5,
        'cluster_patience': 5,
        'cluster_max_epochs': 100,
        'cluster_learning_rate': 0.003,
        'cluster_word2vec_batch_size': 8192,
        'cluster_valid_batch_size': 16384,
        'cluster_min_delta': 0.0001,
